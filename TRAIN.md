...
Download `AntiSite_benchmark_structures.zip` from
[Zenodo](https://doi.org/10.5281/zenodo.21705412), then extract it directly into the repository root:

```bash
unzip /path/to/AntiSite_benchmark_structures.zip -d .
```
